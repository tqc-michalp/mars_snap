defmodule MarsSnapWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(MarsSnapWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(MarsSnapWeb.Gettext, "errors", msg, opts)
    end
  end
